...
//			printf("event\n\r");
	...
	int a=axis[1]/290+128;	//left toggle -up/down
	int aa=axis[0]/290+128; // left toggel - right/left
	int b=axis[3]/290+128;	// right toggle - left/right
	int c=axis[4]/290+128; //right toggle - up/down
